...
;!function(){
    ...
    ,link: function(href, fn, cssname){
      ...
      (function poll() { 
        if(++timeout > 8 * 1000 / 100){
          return window.console && console.error('laydate.css1: Invalid');
        };
  ...
  ,laydate = {
    ...
    ,ready: function(fn){
      ...
      ,path = (isLayui ? 'modules/laydate/' : 'theme/') + 'default/laydate.css1?v='+ laydate.v + ver;
  ...
  Class.prototype.render = function(){
    ...
    if(/^#/.test(options.theme)){
      ...
      if('styleSheet' in style){
        style.setAttribute('type', 'text/css1');
